module RupeeToWords
  # Use Inject with KeyValue - This is unnecessary
  ...
  #breaks number into parts 123 -> ["00", "00", "00", "1", "23"]
  ...
  # This function needs to be the interface. Handles big numbers by recursively
  # calling itself.
